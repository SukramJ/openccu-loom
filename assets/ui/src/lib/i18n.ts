...
const EN: Catalog = {
  ...
  "diagnostics.rssi.title": "Signal / RSSI matrix",
  "diagnostics.rssi.hint": "On-demand RF reception strengths between devices and their communication partners (dBm). Loading queries the CCU radio.",
  "diagnostics.rssi.not_loaded": "Not loaded yet.",
  "diagnostics.rssi.empty": "No RF reception data reported.",
  "diagnostics.rssi.partner": "Partner",
...
const DE: Catalog = {
  ...
  "diagnostics.interfaces": "Interfaces",
  "diagnostics.rssi.title": "Signal / RSSI-Matrix",
  "diagnostics.rssi.hint": "Empfangsfeldstärken zwischen Geräten und ihren Kommunikationspartnern (dBm), auf Anforderung. Das Laden fragt das CCU-Funkmodul ab.",
  "diagnostics.rssi.not_loaded": "Noch nicht geladen.",
  "diagnostics.rssi.empty": "Keine RF-Empfangsdaten gemeldet.",
  "diagnostics.rssi.partner": "Partner",
