...
const EN: Catalog = {
  ...
  "devicelist.view_list": "List view",
  ...
  "inbox.install_mode_all_interfaces": "All interfaces",
  "inbox.install_mode_banner_on": "Pairing mode active ({seconds} s).",
  "inbox.install_mode_banner_off": "Pairing mode stopped.",
...
const DE: Catalog = {
  ...
  "devicelist.view_list": "Listenansicht",
  ...
  "inbox.install_mode_all_interfaces": "Alle Schnittstellen",
  "inbox.install_mode_banner_on": "Anlernmodus aktiv ({seconds} s).",
  "inbox.install_mode_banner_off": "Anlernmodus beendet.",
