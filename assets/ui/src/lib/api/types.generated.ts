...
export interface paths {
    ...
    "/system/addon-update": {
         ...
         *     (`/bin/install_addon`, i.e. OpenCCU); elsewhere
    ...
    "/system/ccu/{central}/recovery-mode": {
         ...
         * @description Restarts the CCU into the separate recovery system reachable on the CCU's own address. OpenCCU only - a stock CCU3 has no such method and the error is reported rather than swallowed. Admin-gated and audited. Answers 202 once the CCU accepted the request; 422 when the central's backend cannot host the action (CUxD, Homegear, or a firmware without the method).
         */
