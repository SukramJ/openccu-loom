...
func TestParseSimpleScheduleActiveSlots(t *testing.T) {
	t.Parallel()
	entries := parseSimpleSchedule(fixtureSimpleScheduleHmIPPSM(), nil)
	if len(entries) != 2 {
...
func TestSerializeSimpleScheduleZeroesUnusedSlots(t *testing.T) {
	...
	}, schedulemodel.SimpleMaxSlot, nil, weekprofile.AstroOffsetLimits{})
	if err != nil {
		t.Fatalf("serialize: %v", err)
	}
	want := (1 << 1) | (1 << 3) // Mo + We
...
func TestSerializeSimpleScheduleRoundTrip(t *testing.T) {
	...
	raw, err := serializeSimpleSchedule(in, schedulemodel.SimpleMaxSlot, nil, weekprofile.AstroOffsetLimits{})
	if err != nil {
		t.Fatalf("serialize: %v", err)
	}
	out := parseSimpleSchedule(raw, nil)
...
func TestSerializeSimpleScheduleAstroAndDuration(t *testing.T) {
	...
	raw, err := serializeSimpleSchedule(in, schedulemodel.SimpleMaxSlot, astroDurationTargetBits, weekprofile.AstroOffsetLimits{})
	if err != nil {
		t.Fatalf("serialize: %v", err)
	}
	...
	// Target channels: 1_1 = bit 0 (=1), 2_1 = bit 1 (=2) → 3
	if raw["01_WP_TARGET_CHANNELS"] != 3 {
		t.Errorf("TARGET_CHANNELS: got %v, want 3", raw["01_WP_TARGET_CHANNELS"])
	}
	...
	out := parseSimpleSchedule(raw, astroDurationTargetBits)
	if len(out) != 1 {
...
func TestSerializeSimpleScheduleSlotOutOfRange(t *testing.T) {
	...
	_, err := serializeSimpleSchedule([]hmapi.SimpleScheduleEntry{e}, schedulemodel.SimpleMaxSlot, nil, weekprofile.AstroOffsetLimits{})
	if err == nil {
...
func TestSerializeSimpleScheduleSlotTooHigh(t *testing.T) {
	...
	if _, err := serializeSimpleSchedule(
		[]hmapi.SimpleScheduleEntry{baseEntry(25)}, schedulemodel.SimpleMaxSlot, nil, weekprofile.AstroOffsetLimits{},
	); err != nil {
		t.Errorf("slot 25 must serialize: %v", err)
	}
	if _, err := serializeSimpleSchedule(
		[]hmapi.SimpleScheduleEntry{baseEntry(schedulemodel.SimpleMaxSlot + 1)}, schedulemodel.SimpleMaxSlot, nil, weekprofile.AstroOffsetLimits{},
	); err == nil {
...
func TestSerializeSimpleScheduleDuplicateSlot(t *testing.T) {
	...
	e1 := baseEntry(1)
	e2 := baseEntry(1)
	_, err := serializeSimpleSchedule([]hmapi.SimpleScheduleEntry{e1, e2}, schedulemodel.SimpleMaxSlot, nil, weekprofile.AstroOffsetLimits{})
	if err == nil {
...
func TestSerializeSimpleScheduleSunsetAstroType(t *testing.T) {
	...
	e := baseEntry(1)
	e.AstroType = "sunset"
	out, err := serializeSimpleSchedule([]hmapi.SimpleScheduleEntry{e}, schedulemodel.SimpleMaxSlot, nil, weekprofile.AstroOffsetLimits{})
	if err != nil {
...
func TestSerializeSimpleScheduleLockAutorelockEnd(t *testing.T) {
	...
	m, err := serializeSimpleScheduleWithDomain(entries, "lock", schedulemodel.SimpleMaxSlot, nil, weekprofile.AstroOffsetLimits{})
	if err != nil {
...
func TestSerializeSimpleScheduleSwitchEmptyDuration(t *testing.T) {
	...
	m, err := serializeSimpleScheduleWithDomain(entries, "switch", schedulemodel.SimpleMaxSlot, nil, weekprofile.AstroOffsetLimits{})
	if err != nil {
