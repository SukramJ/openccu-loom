...
func TestBridge_EmitEvent_AppendsToLog(t *testing.T) {
	...
	b.EmitEvent(0, 0x0028, 0x00, "startup-payload", matterport.EventPriorityCritical)
	b.EmitEvent(0, 0x0033, 0x03, "bootreason-payload", matterport.EventPriorityCritical)
	b.EmitEvent(1, 0x0039, 0x02, "reachable-payload", matterport.EventPriorityCritical)
...
func TestBridge_EmitEvent_EventLogNumberConsistency(t *testing.T) {
	...
	for i := range 5 {
		b.EmitEvent(0, 0x0028, uint32(i), nil, matterport.EventPriorityCritical) //nolint:gosec // G115: i is range 0..4, fits uint32
	}
...
func TestBridge_ReadEvent_ReturnsBufferedEvents(t *testing.T) {
	...
	b.EmitEvent(0, 0x0028, 0x00, nil, matterport.EventPriorityCritical) // StartUp
	b.EmitEvent(0, 0x0033, 0x03, nil, matterport.EventPriorityCritical) // BootReason
	b.EmitEvent(1, 0x0039, 0x02, nil, matterport.EventPriorityCritical) // ReachableChanged
