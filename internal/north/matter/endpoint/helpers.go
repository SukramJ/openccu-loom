...
// codegen'd from docs/parity/matter/matter-schema-snapshot.json via
...
// in docs/parity/by_design.md task #66. Unknown device-type IDs fall
...
func deviceTypeRevision(deviceType uint16) uint16 {
	...
	// docs/parity/by_design.md task that documents the divergence.
...
func customDeviceTypeRevision(_ uint16) (uint16, bool) {
	...
	//   case 0x0016: // RootNode — Apple-Home bypass (docs/parity/by_design.md)
	//       return 3, true
	return 0, false
}
