...
func StartRPCRecording(svc RPCRecorderService, rec audit.Recorder) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		auditRecord(rec, r, "diagnostics.rpc_recording_start", req.Centrals)
...
func StopRPCRecording(svc RPCRecorderService, rec audit.Recorder) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		auditRecord(rec, r, "diagnostics.rpc_recording_stop", req.Centrals)
...
func auditRecord(rec audit.Recorder, r *http.Request, action string, centrals []string) {
	if rec == nil {
		return
	}
	note := "centrals=all"
