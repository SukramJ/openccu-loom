...
>
> Requirements context: the cross-stack snapshot pipeline under `script/` and `notes/parity/by_design.md`. The model snapshot
> (`notes/parity/model_snapshot_schema.md`) checks the wire→domain
