...
[ADR 0048](../../docs/adr/0048-chiptool-godevccu-send-receive-matrix.md) (send/receive
...
`notes/parity/by_design.md`, matter.js section).
...
- Any daemon-side gap found here that is a deliberate divergence goes into
  `notes/parity/by_design.md`; any behavioural fix adds or extends a parity
