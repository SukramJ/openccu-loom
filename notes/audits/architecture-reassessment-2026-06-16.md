...
> **HISTORICAL — a point-in-time scorecard, not current state.** This is the
> terminal entry of the June 2026 audit series (analysis → 06-15 re-score →
> this one). The scores have not been re-measured since, and the repo has
> shipped many releases past them. For what is currently open, read
> [`deep-audit-backlog.md`](./deep-audit-backlog.md).
