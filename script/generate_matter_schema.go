...
// docs/parity/matter/matter-schema-snapshot.json and emits typed Go constant
...
const (
	snapshotPath    = "docs/parity/matter/matter-schema-snapshot.json"
...
func writeClustersFile(clusters []snapshotCluster) error {
	...
	buf.WriteString("// docs/parity/matter/matter-schema-snapshot.json.\n")
