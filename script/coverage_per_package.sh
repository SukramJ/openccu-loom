...
declare -A TIER_CORE=(
    ...
    [internal/central/events]=95       # current 98.3
    ...
    [internal/store/sqlite]=87         # current 90.3 (coverpkg)
    [internal/store/dynamic]=94        # current 97.4
    ...
    [internal/boundary]=97             # current 100.0
