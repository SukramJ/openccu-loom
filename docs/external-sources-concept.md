...
- [`docs/alarm-concept.md`](alarm-concept.md) — the add-on this pattern
  was extracted from.
- [ADR 0007](adr/0007-strong-model-source-interface.md) — the
  `payload.Source` contract that makes one mapping reach every
  north-bound surface.
- [`docs/user/home-assistant.md`](user/home-assistant.md) — how the
